        ...
        <div className="bg-gray-bg border-b border-gray-border">
          <div className="container-site py-3">
            <div className="flex items-center gap-2 text-sm text-gray-text">
              ...
              <span>/</span>
              <Link href="/thue-nha" className="hover:text-gold transition-colors">Căn hộ cho thuê</Link>
              <span>/</span>
        ...
        <div className="container-site py-10">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            <div className="lg:col-span-2 space-y-8">
              <Link href="/thue-nha" className="inline-flex items-center gap-2 text-sm text-gray-text hover:text-gold transition-colors">
                <ArrowLeft size={16} />
                Căn hộ cho thuê
              </Link>
