...
import PropertyListClient from "@/components/layout/sections/PropertyListClient";
import CompactListingHero from "@/components/layout/sections/CompactListingHero";
